package product.rest.client.resource.v1_0;
...
import product.rest.client.problem.Problem;
...
public interface ProductResource {
	...
	public static class ProductResourceImpl implements ProductResource {
		...
		public HttpInvoker.HttpResponse getProductsPageHttpResponse(
			...
			if (inStock != null) {
				httpInvoker.parameter("inStock", String.valueOf(inStock));
			}
		...
		public HttpInvoker.HttpResponse putProductCategoriesHttpResponse(
			...
			httpInvoker.body(productCategories.toString(), "application/json");
		...
		public HttpInvoker.HttpResponse putProductTagsHttpResponse(
			...
			httpInvoker.body(productTags.toString(), "application/json");
