...
@io.swagger.v3.oas.annotations.media.Schema(requiredProperties = {"tagIds"})
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ProductTags")
public class ProductTags implements Serializable {

	public static ProductTags toDTO(String json) {
		return ObjectMapperUtil.readValue(ProductTags.class, json);
	}

	public static ProductTags unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ProductTags.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "product.rest.dto.v1_0.ProductTags",
		name = "x-class-name"
	)
